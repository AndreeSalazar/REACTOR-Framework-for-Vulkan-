            ...
            match enemy.state {
                EnemyState::Alive => {
                    ...
                    if dist > ENEMY_ATTACK_DIST {
                        ...
                        // Face toward the player correctly (native model looks at +Z, offset by PI)
                ...
                EnemyState::Dying => {
                    ...
                    // Keep correct facing yaw direction when falling (native model looks at +Z, offset by PI)
